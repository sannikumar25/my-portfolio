          ...
          <Card className="p-6 shadow-xl rounded-2xl backdrop-blur-lg bg-[#1E293B]/50 border border-[#2DD4BF]/20 overflow-hidden">
            ...
            >
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                Web Developer and UI/UX enthusiast with a passion for clean
                code, interactive design, and smooth animations. I'm focused on
                building responsive and modern web experiences using
                technologies like HTML, CSS, JavaScript, React, and MongoDB.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
                Hailing from the vibrant land of Bihar, India — when I'm not
                coding or designing, you'll catch me playing cricket 🏏,
                exploring new movies 🎬, or diving deep into DevOps tools like
                Linux and GitHub.
              </p>
            </motion.div>
          </Card>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-400">Critical Mass</p>
                </div>
              </motion.div>
            </motion.div>
          </Card>
